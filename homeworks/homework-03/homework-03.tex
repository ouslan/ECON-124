...
\begin{homeworkProblem}
	...
	\begin{enumerate}
		...
		\item Use the $F$ test to test the hypothesis that all coefficients except the constant
		      term are zero.
		\item Use the $F$ statistic to test the joint hypothessi that the coefficient on the four
...
\begin{homeworkProblem}
	In a paper in 1963, Mare Nerlove analyzed a cost function for 145 American electric copmanies.
	The attached data file, contains the data and the description file. Nerlov was interested in
...
\begin{homeworkProblem}
	...
	textbook.the data set can be dwonloaded form the link below:
\end{homeworkProblem}
